...
export class Trips extends Component
{
    ...
    populateTripsData() {
        axios.get("v1/Trips/GetTrips")
            .then(r => {
                const response = r.data;
                this.setState({trips: response, loading: false, failed: false, errorMsg: ''});
            })
            .catch(e => {
                this.setState({trips: [], loading: false, failed: true, errorMsg: 'Trips could not be loaded'});
            });
    }
